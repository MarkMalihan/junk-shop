...
export const PRODUCTS: Product[] = [
    ...
    features: [
      {
        name: "Profiles",
        description:
          "Separate workspaces (e.g. work, personal). Each profile has its own notes, folders, and tags.",
      },
      {
        name: "Folders",
      ...
      },
      {
        name: "Notes",
        description:
          "Create, edit, pin, archive, and share with your other profiles (on this device only—not social or link sharing). Markdown content and image attachments. Soft and hard delete.",
      },
      {
        name: "Comments",
      ...
      },
      {
        name: "Tags",
        description:
          "Per-profile tags. Filter notes by tag, status, date, or search.",
      },
      {
        name: "Theme",
        description:
          "Light/dark mode with optional schedule (e.g. dark at night).",
      },
      {
        name: "Local-first",
        description:
          "Data stays on your device. No account or server required.",
      },
    ],
    photos: [
      {
    ...
    features: [
      {
        name: "Workspaces",
        description:
          "Separate API contexts by project/team and switch between them quickly.",
      },
      {
        name: "Collections",
        description:
          "Organize requests in folder trees for cleaner endpoint grouping.",
      },
      {
        name: "Request Editor",
        description:
          "Build requests with method, URL, query params, headers, and body (JSON/text/form-data).",
      },
      {
        name: "Environments",
        description:
          "Store variables and inject placeholders (for example {{BASE_URL}}) at send time.",
      },
      {
        name: "Response Viewer",
        description:
          "View status code, response headers, and formatted body after execution.",
      },
      {
        name: "Theme",
      ...
      },
      {
        name: "Local-first",
        description:
          "Data and configuration stay on your device; no cloud account required.",
      },
    ],
    photos: [
      {
    ...
    features: [
      {
        ...
        description:
          "Create, select, update, and delete named groups of installed apps.",
      },
      {
        name: "Installed Apps Picker",
        description:
          "Pull apps from your system and add them to a group quickly.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Group and item data are saved in local SQLite, not cloud services.",
      },
      {
        name: "Response Viewer",
        description:
      ...
      },
      {
        name: "Theme",
        description:
          "Built-in theme support for comfortable day and night usage.",
      },
    ],
    photos: [
      {
    ...
    features: [
      {
        ...
        description:
          "Register local directories (for example a projects folder) and switch between them.",
      },
      {
        name: "Repository picker",
        description:
          "Choose which repo under the active root you are browsing.",
      },
      {
        name: "File tree",
        description:
          "Expandable tree with loading from disk; optional search to filter the tree while you work.",
      },
      {
        name: "File preview",
        description:
          "Open a file to see Markdown (preview or code), highlighted code/text, or an asset-oriented view when applicable.",
      },
      {
        name: "Copy",
      ...
      },
      {
        ...
        description:
          "Open the current location in the OS file explorer where supported.",
      },
      {
        name: "Theme",
      ...
      },
      {
        name: "Local-first",
        description:
          "Trees and file reads happen on your device; workspace records stay local.",
      },
    ],
    photos: [
      {
  ...
  },
  {
    ...
    type: "web",
    image: DEFAULT_IMAGE,
    tags: ["business", "webapp", "demo-nyo"],
    description:
      "Admin dashboard for managing products, categories, inventory, and orders.",
    version: "v0.1.0",
    features: [
      {
        name: "Dashboard",
        description:
          "View key business metrics including sales, orders, products, inventory, and recent activity at a glance.",
      },
      {
        name: "Categories CRUD",
        description:
          "Create, edit, organize, and remove product categories to keep your catalog structured.",
      },
      {
        name: "Products CRUD",
        description:
          "Manage products with images, pricing, SKUs, stock levels, status, and category assignments.",
      },
      {
        name: "Inventory",
        description:
          "Track product stock in real time and automatically deduct inventory when orders are fulfilled.",
      },
      {
        name: "Orders",
        description:
          "View customer orders, update order and payment statuses, inspect purchased items, and manage fulfillment.",
      },
      {
        name: "Seed Demo Data (Orders)",
        description:
          "Generate realistic demo orders with optional inventory deduction or simulate sales without affecting stock.",
      },
      {
        name: "Local-first",
        description:
          "All data is stored locally in your browser using IndexedDB, allowing the prototype to run entirely offline.",
      },
    ],
    link: "https://demo-nyo.vercel.app/prototype/ecommerce-admin",
  },
];
